...
const varificationEmailTemplate = ({user,url})=>{
...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_heading_1 .v-container-padding-padding { padding: 30px 10px 20px !important; } #u_content_heading_1 .v-font-size { font-size: 24px !important; } #u_content_image_1 .v-container-padding-padding { padding: 45px 10px 10px !important; } #u_content_heading_2 .v-font-size { font-size: 20px !important; } #u_content_text_1 .v-container-padding-padding { padding: 10px !important; } #u_content_button_1 .v-size-width { width: 65% !important; } #u_content_button_1 .v-container-padding-padding { padding: 10px 10px 40px !important; } #u_content_text_3 .v-container-padding-padding { padding: 40px 10px 10px !important; } #u_content_menu_1 .v-padding { padding: 5px 10px !important; } }
    </style>
...
<table id="u_content_heading_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 28px; font-weight: 400;"><span><strong>NexaMart</strong></span></h1>
...
<table id="u_content_heading_2" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 25px; font-weight: 400;"><span>Welcome To Nexamart ${user} </span></h1>
  <!--[if mso]></td></tr></table><![endif]-->
...
<p style="line-height: 140%; margin: 0px;">we are welcome to aver nexamart family.</p>
  </div>
...
<a href="${url}" target="_blank" class="v-button v-size-width v-font-size" style="box-sizing: border-box; display: inline-block; text-decoration: none; text-size-adjust: none; text-align: center; color: rgb(255, 255, 255); background: rgb(2, 2, 170); border-radius: 4px; width: 31%; max-width: 100%; word-break: break-word; overflow-wrap: break-word; font-size: 14px; line-height: inherit;"><span class="v-padding" style="display:block;padding:10px 20px;line-height:120%;"><span style="font-size: 14px; line-height: 16.8px;">Verifiye Me</span></span>
    </a>
...
<a href="https://www.unlayer.com" target="_self" style="padding: 5px 15px; display: inline-block; color: rgb(91, 91, 91); font-size: 14px; text-decoration: none; line-height: inherit;" class="v-padding v-font-size">Home
    </a>
...
<a href="https://www.unlayer.com" target="_self" style="padding: 5px 15px; display: inline-block; color: rgb(91, 91, 91); font-size: 14px; text-decoration: none; line-height: inherit;" class="v-padding v-font-size">Page
    </a>
...
<a href="https://www.unlayer.com" target="_self" style="padding: 5px 15px; display: inline-block; color: rgb(91, 91, 91); font-size: 14px; text-decoration: none; line-height: inherit;" class="v-padding v-font-size">About Us
    </a>
...
<a href="https://www.unlayer.com" target="_self" style="padding: 5px 15px; display: inline-block; color: rgb(91, 91, 91); font-size: 14px; text-decoration: none; line-height: inherit;" class="v-padding v-font-size">Contact US
    </a>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-font-size" style="font-size: 14px; color: #5b5b5b; line-height: 160%; text-align: center; word-wrap: break-word;">
<p style="font-size: 14px; line-height: 160%; margin: 0px;">you have received this email as a registered user of <a rel="noopener" href="https://www.unlayer.com" target="_blank" style="color: rgb(0, 0, 238); text-decoration: underline; line-height: inherit;">yourcompany.com</a></p><p style="font-size: 14px; line-height: 160%; margin: 0px;">can <a rel="noopener" href="https://www.unlayer.com" target="_blank" style="color: rgb(0, 0, 238); text-decoration: underline; line-height: inherit;">unsubscribe</a> from these emails here.</p><p style="font-size: 14px; line-height: 160%; margin: 0px;"></p>
<p style="font-size: 14px; line-height: 160%; margin: 0px;">2361 Market Street #4567 San Francisco, CA 94124 All rights reserved</p>
  </div>
...
export default varificationEmailTemplate;